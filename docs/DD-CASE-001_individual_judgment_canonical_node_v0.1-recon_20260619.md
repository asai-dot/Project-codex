...
- lifecycle: **draft / candidate**（GPT Pro 独立意味監査 未了 → DDCASESOURCE ゲートで審査）
...
- deterministic_self_verification = **pending**（negative_test 再構成・builder 実行後）
- independent_meaning_audit = **未了**（本 recon 版を DDCASESOURCE ゲートへ投函）
- owner_approval = **未了**
