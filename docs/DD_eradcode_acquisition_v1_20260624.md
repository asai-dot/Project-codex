...
**E-2. seed逆引き（bounded fetch・実現性確認済 2026-06-24）**: 73,155 scholar を**人起点照会**。全件クロールしない。
  ...
  - **層別**: 1000系3,654=研究者番号保有で確実逆引き（実質E-1と重複）。**9000系69,501=研究者番号なし → 氏名/researchmap/ORCID(CiNii detail由来)で課題検索側マッチが必要**、かつ科研費保有率自体が低い見込み。
  - **着手前に層別サンプル500件で歩留まり実測**（9000系の科研費保有率＝逆引きhit率）。Phase B方針(stratified sampleで漏れ率測定)と一致。
