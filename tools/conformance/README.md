...
| `indep_lineage.py` | INDEP-LINEAGE v0.1 | 独立性 lineage 正本（content group/collapse_key・observation raw_input_hash root・object_id/scan_id では数えない・B4 修正版 7 fixture） |
| `reconcile_indep_registry.py` | RECONCILE §1 | family_kind→axis 語彙写像のみ（カウントは indep_lineage が正本） |
