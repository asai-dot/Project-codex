...
- XDOC 残: `range_class` adapter の grid_2d/rect_2d（interval_1d は実装済）・method capability
  （required companion ⊆ applied）・use_assessment revision 履歴・cluster pairwise_support_coverage。
