...
- LAYOUT: page_block hash bundle（5種）・block_ref stitching・projection の coverage metadata 拡張。
- XDOC 残: method capability（required companion ⊆ applied）・use_assessment revision 履歴・
  cluster pairwise_support_coverage（support_edge_effective は実装済）。
