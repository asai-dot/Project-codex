...
const BUSINESS_FIELDS = ["Id","Name","leala__Status__c","leala__ChargeLawyer__c","leala__Clerk__c","leala__Team__c","leala__Source__c","leala__SourceMiddle__c","leala__SourcePartner__c","leala__CaseCategorySingle__c","case_field_big__c","case_field_middle__c","case_field_small__c","leala__CaseCategory__c","leala__MandatoryDate__c","leala__CloseDate__c","leala__ExpectedCloseDate__c","leala__Deadline__c","leala__IsDeadlineActive__c","ALO_Next_Deadline_At__c","ALO_Waiting_On__c","ALO_Outcome__c","leala__Consultation__c","leala__UploadFolderUrlBox__c","leala__AccountName__c","Earnings__c","leala__RetainerFeeTotal__c","leala__RewardTotal__c","leala__ActualCostTotal__c","leala__TimeChargeActualMinutesTotal__c","leala__TimeChargeTotal__c","leala__Memo__c","leala__CaseOutline__c","CreatedDate","LastModifiedDate"];
